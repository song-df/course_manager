...
# 第3章：继承
> 授课PPT
> 1. [第三章:继承.pdf](cpp_language_resource/part1/chapter03/pptx/cpp_language_chapter03_1.pdf)  
> 
> 参考程序
> 1. [1.inherit.cpp](cpp_language_resource/part1/chapter03/code/1.inherit.cpp)
> 2. [2.obj_size.cpp](cpp_language_resource/part1/chapter03/code/2.obj_size.cpp)
> 3. [3.inherit_pointer.cpp](cpp_language_resource/part1/chapter03/code/3.inherit_pointer.cpp)
> 4. [4.subclass_satorage](cpp_language_resource/part1/chapter03/code/4.subclass_storage.cpp)
> 5. [5.inherit_constructor_order.cpp](cpp_language_resource/part1/chapter03/code/5.inherit_constructor_order.cpp)
> 6. [6.call_father_constructor.cpp](cpp_language_resource/part1/chapter03/code/6.call_father_constructor.cpp)
> 7. [7.inherit_permission.cpp](cpp_language_resource/part1/chapter03/code/7.inherit_permission.cpp)
